...
const ContactUs = () => {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm("service_j9ymt04", "template_9b7t84i", form.current, "b85Jl3R5SfRDirFR-")
      .then(() => {
  ...
  return (
    <>
      <div id="contact-page" className="flex items-center justify-center min-h-[100vh] bg-[url(/src/assets/auth-bg.png)]* bg-no-repeat* bg-cover*">
