...
export const GetCasesRequest = async (token) => {
  const response = await axios.get(`${baseURL}/superadmin/cases/all`, {
...
export const GetCaseByIdRequest = async (token, caseID) => {
  const response = await axios.get(
    `${baseURL}/superadmin/cases/search/${caseID}`,
    {
      maxBodyLength: Infinity,
      headers: {
        Accept: "application/vnd.connect.v1+json",
...
export const CreateCaseRequest = async (body, token) => {
  try {
    const response = await axios.post(`${baseURL}/superadmin/cases/new`, body, {
      headers: {
        Accept: "application/vnd.connect.v1+json",
        Authorization: `Bearer ${token}`,
      },
...
export const EditCaseRequest = async (token, editCaseID, body) => {
  try {
    const response = await axios.put(
      `${baseURL}/superadmin/cases/update/${editCaseID}`,
      body,
      {
        headers: {
          Accept: "application/vnd.connect.v1+json",
...
export const DeleteCaseRequest = async (token, deleteCaseID) => {
  const response = await axios.delete(
    `${baseURL}/superadmin/cases/delete/${deleteCaseID}`,
    {
      maxBodyLength: Infinity,
      headers: {
        Accept: "application/vnd.connect.v1+json",
...
// GET(READ) ALL LIST OF COURT REGISTRARS
export const GetRegisteredRegistrarRequest = async (token) => {
  const response = await axios.get(`${baseURL}/superadmin/registered-registrar`, {
    maxBodyLength: Infinity,
    headers: {
      Accept: "application/vnd.connect.v1+json",
      Authorization: `Bearer ${token}`,
...
export const UploadCaseByCsvRequest = async (body, token) => {
  try {
    const response = await axios.post(
      `${baseURL}/superadmin/cases/csvupload`,
      body,
      {
        headers: {
          Accept: "application/vnd.connect.v1+json",
