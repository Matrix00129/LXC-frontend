...
import { GetDashboardActivityLogsRequest } from "../../../Services/CourtRegistrarRequest/dashboard.request";
...
const StatisticsCard = () => {
  ...
  return (
    <>
      <div>
        <section className="bg-[#524A4C] grid grid-cols-2 p-8 mt-6 lg:h-[150px] rounded-2xl text-white justify-center md:grid-cols-4 lg:flex items-center lg:justify-between pl-8 lg:px-20">
          {/* Statistics One */}
          <div className="lg:flex items-center gap-4 md:border-r-[1.4px] md:border-white h-fit md:pr-10 md:pl-4">
            ...
            <div>
              <p className="text-[20px] md:text-[32px] font-bold">
                {" "}
                {activityLogsData?.data?.totalSearches}
              </p>
